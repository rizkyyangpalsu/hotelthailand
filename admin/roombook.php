...
?>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th>Image</th>
                                            <th><img src="../assets/uploads/<?php echo $image ?>" alt=""
                                                     style="width: 150px;" id="imageView" value="<?php echo $image?>"/></th>
                                        </tr>
                            ...
                            <div class="panel-body">
                                <table width="200px">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-danger btn-circle"><?php
    ...
    <script type="text/javascript">
        let image = document.querySelector('#imageView');

        if (image !== null && image !== undefined) {
            image.onclick = function () {
                let url = image.getAttribute('value');
                window.location.href = '/assets/uploads/' + url;
            }
        }
    </script>
